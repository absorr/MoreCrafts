...
{
    private TileEntityInversion furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerInversion(InventoryPlayer par1InventoryPlayer, TileEntityInversion par2TileEntityFurnace)
    {
    ...
    public void updateCraftingResults()
    {
        ...
        this.lastCookTime = this.furnace.invFurnaceCookTime;
        this.lastBurnTime = this.furnace.invFurnaceBurnTime;
    ...
    public void updateProgressBar(int par1, int par2)
    {
        if (par1 == 0)
        {
            this.furnace.invFurnaceCookTime = par2;
        }

        if (par1 == 1)
        {
            this.furnace.invFurnaceBurnTime = par2;
        }
